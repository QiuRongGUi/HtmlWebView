...
@interface ViewController ()<UIWebViewDelegate,ZLPhotoPickerBrowserViewControllerDelegate>{
...
//    NSString *str = @"https://uav.zstxq.cn/index.php/api/news/details/contenthtml?id=26&sys=mobile";
//
//    [web loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:str]]];
    
    [self getHTMLData];
    
    [web loadHTMLString:_HTMLData baseURL:nil];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType{
    ...
    if(navigationType == UIWebViewNavigationTypeLinkClicked){
        ...
        vc.URLString = request.URL.absoluteString;
